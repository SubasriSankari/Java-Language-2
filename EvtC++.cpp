...
CONST LPWSTR pEventTypeNames[] = {(LPWSTR)L"Error", (LPWSTR)L"Warning", (LPWSTR)L"Informational", (LPWSTR)L"Audit Success", (LPWSTR)L"Audit Failure"};
...
#define PROVIDER_NAME           (LPCSTR)L"MyEventProvider"
#define RESOURCE_DLL            L"<path>\\Provider.dll"
